...
#else
#define OPTEE_SHMEM_BASE		0x41200000
#endif
...
#else
#define OPTEE_TZDRAM_BASE		0x41800000
#endif
...
#define OPTEE_MAILBOX_BASE		0x97000000
#define OPTEE_MAILBOX_SIZE		0x4000
