...
#if __riscv_xlen == 32
#define CHECKED_ADD(a, b, out) (__builtin_uadd_overflow(a, b, out))
#else
#define CHECKED_ADD(a, b, out) (__builtin_uaddl_overflow(a, b, out))
#endif

#define sm_assert assert
...
int pmp_set_permission(region_id n, uint8_t perm);
